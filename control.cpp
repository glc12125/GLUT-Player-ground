...
double xOrigin = -1.0f;
double yOrigin = -1.0f;
double mouseSpeed = 0.0005f;

M3DVector3d camPos;
M3DVector3d directionVec;
M3DVector3d upVec;
...
void renderScenesw1() {
    ...
    /*gluLookAt(x, y, z,
              ...
              0.0f,1.0f,0.0f);*/
    gluLookAt(x, y, z,
              x + directionVec[0],y + directionVec[1],z + directionVec[2],
...
void renderScenesw2() {
    ...
    glTranslatef(x,y,z);
    glRotatef(180-(angle+horizontalAngle)*180.0/3.14,0.0,1.0,0.0);
...
void mouseMove(int x, int y) {
    ...
    if (xOrigin >= 0 || yOrigin >= 0) {
        ...
        // update angles
        horizontalAngle = (x - xOrigin) * mouseSpeed;
        verticalAngle = (y - yOrigin) * mouseSpeed;
        // Direction : Spherical coordinates to Cartesian coordinates conversion
        directionVec[0] = lx = cos(verticalAngle) * sin(horizontalAngle);
        directionVec[1] = ly = -sin(verticalAngle);
        directionVec[2] = lz = -cos(verticalAngle) * cos(horizontalAngle);
        
        // Right vector
        M3DVector3d right;
        right[0] =sin(horizontalAngle - 3.14f/2.0f);
        right[1] = 0;
        right[2] = cos(horizontalAngle - 3.14f/2.0f);

        // Up Vector
        m3dCrossProduct3(upVec, directionVec, right);
        // update camera's direction
        //lx = sin(angle + horizontalAngle);
        //lz = -cos(angle + horizontalAngle);
